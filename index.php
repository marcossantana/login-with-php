<?php require_once('Connections/conn_casavelha.php'); ?>
<?php
...
if (isset($_POST['login'])) {
  ...
  $LoginRS__query=sprintf("SELECT login, senha FROM operador WHERE login=%s AND senha=%s",
    GetSQLValueString($loginUsername, "text"), GetSQLValueString($password, "text")); 
   
  $LoginRS = mysql_query($LoginRS__query, $conn_casavelha) or die(mysql_error());
...
<a href="#"><img src="images/logo_mn_sm.png" title="Desenvolvido por:" /></a>
</div>
